...
4/14
Timer component is done, and score updates accordingly. gameOver needs to be added. For now, the focus should be on debugging, grooming the images to remove unsavory ones. also writing logic to ensure there arent repeat images on any playthrough. Also, add a how to play section below the puzzle.
